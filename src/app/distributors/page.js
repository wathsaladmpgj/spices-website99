    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="registration" className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Partnership <span className="text-amber-500">Registration</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Fill out the form below to begin your journey as a SpiceWorld partner. 
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-green-700">
                      Thank you for your interest in partnering with SpiceWorld. 
                      Our team will review your application and contact you within 48 hours.
                    </p>
                  </div>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    ...
                    <option value="grocery">Grocery Chain</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your business, target market, and how you plan to sell our products..."
                />
              </div>
              ...
              <motion.button
                ...
                className={`w-full py-4 rounded-lg font-semibold text-white transition-colors duration-200 ${
                  isSubmitting
